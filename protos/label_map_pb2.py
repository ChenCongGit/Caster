...
# source: Caster/protos/label_map.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Caster/protos/label_map.proto',
  package='Caster.protos',
  serialized_pb=_b('\n\x1d\x43\x61ster/protos/label_map.proto\x12\rCaster.protos\"j\n\x08LabelMap\x12\x32\n\rcharacter_set\x18\x01 \x01(\x0b\x32\x1b.Caster.protos.CharacterSet\x12\x17\n\x0clabel_offset\x18\x02 \x01(\x03:\x01\x30\x12\x11\n\tunk_label\x18\x03 \x01(\x03\"\xc1\x01\n\x0c\x43haracterSet\x12\x15\n\ttext_file\x18\x01 \x01(\t:\x00H\x00\x12I\n\x0c\x62uilt_in_set\x18\x03 \x01(\x0e\x32&.Caster.protos.CharacterSet.BuiltInSet:\tLOWERCASEH\x00\"?\n\nBuiltInSet\x12\r\n\tLOWERCASE\x10\x00\x12\x0c\n\x08\x41LLCASES\x10\x01\x12\x14\n\x10\x41LLCASES_SYMBOLS\x10\x02\x42\x0e\n\x0csource_oneof')
)
...
_CHARACTERSET_BUILTINSET = _descriptor.EnumDescriptor(
  name='BuiltInSet',
  full_name='Caster.protos.CharacterSet.BuiltInSet',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LABELMAP = _descriptor.Descriptor(
  name='LabelMap',
  full_name='Caster.protos.LabelMap',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='character_set', full_name='Caster.protos.LabelMap.character_set', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_offset', full_name='Caster.protos.LabelMap.label_offset', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unk_label', full_name='Caster.protos.LabelMap.unk_label', index=2,
...
_CHARACTERSET = _descriptor.Descriptor(
  name='CharacterSet',
  full_name='Caster.protos.CharacterSet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='text_file', full_name='Caster.protos.CharacterSet.text_file', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='built_in_set', full_name='Caster.protos.CharacterSet.built_in_set', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='source_oneof', full_name='Caster.protos.CharacterSet.source_oneof',
...
LabelMap = _reflection.GeneratedProtocolMessageType('LabelMap', (_message.Message,), dict(
  ...
  __module__ = 'Caster.protos.label_map_pb2'
  # @@protoc_insertion_point(class_scope:Caster.protos.LabelMap)
  ))
...
CharacterSet = _reflection.GeneratedProtocolMessageType('CharacterSet', (_message.Message,), dict(
  ...
  __module__ = 'Caster.protos.label_map_pb2'
  # @@protoc_insertion_point(class_scope:Caster.protos.CharacterSet)
  ))
